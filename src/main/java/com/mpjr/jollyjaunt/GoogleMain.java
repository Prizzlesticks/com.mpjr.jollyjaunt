...
//based on user input, get directions using google API (accessing Json data)
public class GoogleMain {
	...
	public static String GetDirections() {
		...
		String url = "https://maps.googleapis.com/maps/api/directions/json?origin=" + Origin + "&destination="
				+ Destination + "&key=AIzaSyCzbMMCLqhLp1yFuvPmidlbGCMvIgCm4wg";
		String printMe = " ";
		...
		try {
			...
			if (code == 200) {
				...
				in.close();
				// create new object
				// retrieve Json data, pass through input response and
				// directions to create direction instance
				Gson gson = new Gson();
